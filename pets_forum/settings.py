...
CACHES = {
    "default": { # 默认
        ...
        "LOCATION": "redis://192.168.255.131:6379/0",
        "OPTIONS": {
    ...
    "session": { # session
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://192.168.255.131:6379/1",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, 'logs/pets_forum.log'),  # 日志文件的位置
